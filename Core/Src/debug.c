...
void debug_handler(void) {
	if(__HAL_UART_GET_FLAG(debug_huart, UART_FLAG_TXE) && debug_huart->Instance->CR1 & USART_CR1_TXEIE_TXFNFIE)
		debug_tx_e_handler();

	if(__HAL_UART_GET_FLAG(debug_huart, UART_FLAG_RXNE) && debug_huart->Instance->CR1 & USART_CR1_RXNEIE_RXFNEIE)
		debug_rx_ne_handler();
}
